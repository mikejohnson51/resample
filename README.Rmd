...
For each method, an input raster and desired cell size must be provided, cell size is given with respect to the input raster CRS. In our example this is meters (see below). This is the same principle as the `-tr` flag found in GDAL utilities.
...
Overall, we can see that ~46% of the cell, the three methods assigned different categories:
